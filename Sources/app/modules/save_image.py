...
class SaveImage:
    def __init__(self, output_path, ext="", jpg_quality=None, png_compression=None, overwrite=False):
        ...
        self.output_path, self.ext = os.path.splitext(output_path)
        if self.ext == "" and ext != "":
            self.ext = ext
    ...
    def save(self, image, name):
        ...
        path = os.path.join(dirname, filename + image_ext)
